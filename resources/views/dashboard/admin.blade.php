    ...
    <div class="container-fluid border rounded-3 my-5 py-5 border-secondary shadow-lg">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 m-3 p-5 border rounded-3 shadow-sm text-center" style="background-color: #f0f8ff;">
                <a href="{{ route('dataUser.index') }}" class="btn btn-outline-primary w-100 mb-3"
                    style="border-radius: 30px;">Data User</a>
                <h3 class="h5 text-primary">Data User Pengguna Aplikasi</h3>
            </div>
            <div class="col-md-4 m-3 p-5 border rounded-3 shadow-sm text-center" style="background-color: #feffd6;">
                <a href="{{ route('dataPendaftar.index') }}" class="btn btn-outline-success w-100 mb-3"
                    style="border-radius: 30px;">Data Pendaftar</a>
                <h3 class="h5 text-success">Data Pendaftar Mahasiswa Baru</h3>
            </div>
            <div class="col-md-4 m-3 p-5 border rounded-3 shadow-sm text-center" style="background-color: #d9ebda;">
                <a href="{{ route('dataPendaftar.lolos') }}" class="btn btn-outline-success w-100 mb-3"
                    style="border-radius: 30px;">Data Pendaftar</a>
                <h3 class="h5 text-success">Daftar Mahasiswa yang lolos</h3>
            </div>
        </div>
